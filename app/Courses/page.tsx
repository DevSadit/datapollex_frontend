...
//               : "bg-white/70 border-white/30 text-gray-800 hover:bg-white/90"
//           }`}
//         >
...
//           {/* Hero Badge */}
//           <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm border border-white/20 mb-8 animate-fade-in">
...
//             }`}
//           >
//             Discover thousands of expert-led courses designed to advance your
//             career and transform your future
//           </p>

//           {/* Stats Row */}
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
//             {[
//               { icon: TrendingUp, label: "5M+ Students", value: "Worldwide" },
//               { icon: Award, label: "50K+ Courses", value: "Available" },
...
//               <div
//                 className={`absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur opacity-20 group-hover:opacity-30 transition-opacity`}
//               ></div>
...
//               <div
//                 key={course.id}
//                 className={`group cursor-pointer rounded-3xl overflow-hidden transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-fade-in backdrop-blur-sm border ${
//                   isDarkMode
...
//                 <div className="p-6">
//                   <h3
//                     className={`font-bold text-xl mb-3 line-clamp-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text transition-all duration-300 ${
//                       isDarkMode ? "text-white" : "text-gray-900"
//                     }`}
//                   >
//                     {course.title}
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <button className={`px-8 py-4 rounded-xl font-semibold border-2 transition-all duration-300 transform hover:scale-105 flex items-center space-x-2 ${
              isDarkMode 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              { icon: BookOpen, title: "Interactive Learning", desc: "Engage with dynamic content" },
              { icon: Users, title: "Expert Instructors", desc: "Learn from industry experts" },
              { icon: Trophy, title: "Certified Courses", desc: "Get recognized certificates" },
            ].map((feature, index) => (
              <div
                key={index}
              ...
              >
                <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center ${
                  index === 0 ? "bg-blue-500/20" : index === 1 ? "bg-purple-500/20" : "bg-pink-500/20"
                }`}>
                  <feature.icon className={`w-8 h-8 ${
                    index === 0 ? "text-blue-500" : index === 1 ? "text-purple-500" : "text-pink-500"
                  }`} />
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            {[
              ...
              { value: "1K+", label: "Expert Instructors" },
